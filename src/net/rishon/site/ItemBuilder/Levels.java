...
public class Levels {
    ...
    public static void getPlayerContent(Player player) {
        ...
        switch (playerLevel) {
            case 1:
                player.getInventory().setItem(0, (new ItemBuilder(Material.WOOD_AXE).setName("§bWooden Axe").setUnbreakable(true).toItemStack()));
                break;
            case 2:
                player.getInventory().setItem(0, (new ItemBuilder(Material.WOOD_SWORD).setName("§bWooden Sword").setUnbreakable(true).toItemStack()));
                break;
            case 3:
                player.getInventory().setItem(0, (new ItemBuilder(Material.WOOD_SWORD).setName("§bWooden Sword").setUnbreakable(true).toItemStack()));
            ...
            case 6:
                ...
                break;
            case 7:
                player.getInventory().setItem(0, (new ItemBuilder(Material.WOOD_AXE).setName("§bWooden Axe").setUnbreakable(true).addEnchant(Enchantment.DAMAGE_ALL, 1).toItemStack()));
                player.getInventory().setHelmet((new ItemBuilder(Material.LEATHER_HELMET).setName("§bLeather Helmet").setUnbreakable(true).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.LEATHER_CHESTPLATE).setName("§bLeather Chestplate").setUnbreakable(true).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.LEATHER_LEGGINGS).setName("§bLeather Leggings").setUnbreakable(true).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.LEATHER_BOOTS).setName("§bLeather Boots").setUnbreakable(true).toItemStack()));
                break;
            case 8:
                player.getInventory().setItem(0, (new ItemBuilder(Material.WOOD_SWORD).setName("§bWooden Sword").setUnbreakable(true).addEnchant(Enchantment.DAMAGE_ALL, 1).toItemStack()));
                player.getInventory().setHelmet((new ItemBuilder(Material.LEATHER_HELMET).setName("§bLeather Helmet").setUnbreakable(true).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.LEATHER_CHESTPLATE).setName("§bLeather Chestplate").setUnbreakable(true).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.LEATHER_LEGGINGS).setName("§bLeather Leggings").setUnbreakable(true).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.LEATHER_BOOTS).setName("§bLeather Boots").setUnbreakable(true).toItemStack()));
            ...
            case 24:
                ...
                break;
            case 25:
                player.getInventory().setItem(0, (new ItemBuilder(Material.GOLD_AXE).setName("§bGolden Axe").setUnbreakable(true).toItemStack()));
                player.getInventory().setHelmet((new ItemBuilder(Material.CHAINMAIL_HELMET).setName("§bChain Helmet").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.CHAINMAIL_CHESTPLATE).setName("§bChain Chestplate").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.CHAINMAIL_LEGGINGS).setName("§bChain Leggings").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.CHAINMAIL_BOOTS).setName("§bChain Boots").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                break;
            case 26:
                player.getInventory().setItem(0, (new ItemBuilder(Material.GOLD_SWORD).setName("§bGolden Sword").setUnbreakable(true).toItemStack()));
                player.getInventory().setHelmet((new ItemBuilder(Material.CHAINMAIL_HELMET).setName("§bChain Helmet").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.CHAINMAIL_CHESTPLATE).setName("§bChain Chestplate").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.CHAINMAIL_LEGGINGS).setName("§bChain Leggings").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.CHAINMAIL_BOOTS).setName("§bChain Boots").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
            ...
            case 27:
                player.getInventory().setItem(0, (new ItemBuilder(Material.GOLD_SWORD).setName("§bGolden Sword").setUnbreakable(true).toItemStack()));
                player.getInventory().setHelmet((new ItemBuilder(Material.GOLD_HELMET).setName("§bGolden Helmet").setUnbreakable(true).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.CHAINMAIL_CHESTPLATE).setName("§bChain Chestplate").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.CHAINMAIL_LEGGINGS).setName("§bChain Leggings").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.CHAINMAIL_BOOTS).setName("§bChain Boots").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                break;
            case 28:
                player.getInventory().setItem(0, (new ItemBuilder(Material.GOLD_SWORD).setName("§bGolden Sword").setUnbreakable(true).toItemStack()));
                player.getInventory().setHelmet((new ItemBuilder(Material.GOLD_HELMET).setName("§bGolden Helmet").setUnbreakable(true).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.GOLD_CHESTPLATE).setName("§bGolden Chestplate").setUnbreakable(true).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.CHAINMAIL_LEGGINGS).setName("§bChain Leggings").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.CHAINMAIL_BOOTS).setName("§bChain Boots").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                break;
            case 29:
                ...
                player.getInventory().setHelmet((new ItemBuilder(Material.GOLD_HELMET).setName("§bGolden Helmet").setUnbreakable(true).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.GOLD_CHESTPLATE).setName("§bGolden Chestplate").setUnbreakable(true).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.GOLD_LEGGINGS).setName("§bGolden Leggings").setUnbreakable(true).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.CHAINMAIL_BOOTS).setName("§bChain Boots").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                break;
            case 30:
                player.getInventory().setItem(0, (new ItemBuilder(Material.GOLD_SWORD).setName("§bGolden Sword").setUnbreakable(true).toItemStack()));
                ...
                player.getInventory().setChestplate((new ItemBuilder(Material.GOLD_CHESTPLATE).setName("§bGolden Chestplate").setUnbreakable(true).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.GOLD_LEGGINGS).setName("§bGolden Leggings").setUnbreakable(true).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.GOLD_BOOTS).setName("§bGolden Boots").setUnbreakable(true).toItemStack()));
                break;
            case 31:
                player.getInventory().setItem(0, (new ItemBuilder(Material.GOLD_AXE).setName("§bGolden Axe").setUnbreakable(true).addEnchant(Enchantment.DAMAGE_ALL, 1).toItemStack()));
                player.getInventory().setHelmet((new ItemBuilder(Material.GOLD_HELMET).setName("§bGolden Helmet").setUnbreakable(true).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.GOLD_CHESTPLATE).setName("§bGolden Chestplate").setUnbreakable(true).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.GOLD_LEGGINGS).setName("§bGolden Leggings").setUnbreakable(true).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.GOLD_BOOTS).setName("§bGolden Boots").setUnbreakable(true).toItemStack()));
                break;
            case 32:
                player.getInventory().setItem(0, (new ItemBuilder(Material.GOLD_SWORD).setName("§bGolden Sword").setUnbreakable(true).addEnchant(Enchantment.DAMAGE_ALL, 1).toItemStack()));
                player.getInventory().setHelmet((new ItemBuilder(Material.GOLD_HELMET).setName("§bGolden Helmet").setUnbreakable(true).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.GOLD_CHESTPLATE).setName("§bGolden Chestplate").setUnbreakable(true).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.GOLD_LEGGINGS).setName("§bGolden Leggings").setUnbreakable(true).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.GOLD_BOOTS).setName("§bGolden Boots").setUnbreakable(true).toItemStack()));
            ...
            case 33:
                player.getInventory().setItem(0, (new ItemBuilder(Material.GOLD_SWORD).setName("§bGolden Sword").setUnbreakable(true).addEnchant(Enchantment.DAMAGE_ALL, 1).toItemStack()));
                player.getInventory().setHelmet((new ItemBuilder(Material.GOLD_HELMET).setName("§bGolden Helmet").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.GOLD_CHESTPLATE).setName("§bGolden Chestplate").setUnbreakable(true).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.GOLD_LEGGINGS).setName("§bGolden Leggings").setUnbreakable(true).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.GOLD_BOOTS).setName("§bGolden Boots").setUnbreakable(true).toItemStack()));
                break;
            case 34:
                player.getInventory().setItem(0, (new ItemBuilder(Material.GOLD_SWORD).setName("§bGolden Sword").setUnbreakable(true).addEnchant(Enchantment.DAMAGE_ALL, 1).toItemStack()));
                player.getInventory().setHelmet((new ItemBuilder(Material.GOLD_HELMET).setName("§bGolden Helmet").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.GOLD_CHESTPLATE).setName("§bGolden Chestplate").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.GOLD_LEGGINGS).setName("§bGolden Leggings").setUnbreakable(true).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.GOLD_BOOTS).setName("§bGolden Boots").setUnbreakable(true).toItemStack()));
                break;
            case 35:
                ...
                player.getInventory().setHelmet((new ItemBuilder(Material.GOLD_HELMET).setName("§bGolden Helmet").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setChestplate((new ItemBuilder(Material.GOLD_CHESTPLATE).setName("§bGolden Chestplate").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.GOLD_LEGGINGS).setName("§bGolden Leggings").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.GOLD_BOOTS).setName("§bGolden Boots").setUnbreakable(true).toItemStack()));
                break;
            case 36:
                player.getInventory().setItem(0, (new ItemBuilder(Material.GOLD_SWORD).setName("§bGolden Sword").setUnbreakable(true).addEnchant(Enchantment.DAMAGE_ALL, 1).toItemStack()));
                ...
                player.getInventory().setChestplate((new ItemBuilder(Material.GOLD_CHESTPLATE).setName("§bGolden Chestplate").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setLeggings((new ItemBuilder(Material.GOLD_LEGGINGS).setName("§bGolden Leggings").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                player.getInventory().setBoots((new ItemBuilder(Material.GOLD_BOOTS).setName("§bGolden Boots").setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack()));
                break;
            case 37:
